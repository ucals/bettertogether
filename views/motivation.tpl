...
<div class="container">
    <div class="row">
        <div class="col-md-8 offset-md-2 col-xs-12 col-sm-10 offset-sm-1">
            ...
            <br/>
            <h4>Motivation</h4>
            <p>My first motivation to start this side project came from my personal struggle to form a team, to work in OMSCS EdTech final project. In spite of deeply believing that we perform much better when working in teams, I could not successfully do it.<p>
